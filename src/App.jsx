...
if (ProvidedData.data().Data) {
  ...
  return (
    <div>
      ...
      {/* <UserProvidedFound/> */}
      <Routes>
        <Route path='' element={<Landingpage setOpenState={setOpenState} />}></Route>
        <Route path="/signup" element={ <SignUpPage/>}></Route>
        <Route path="/FoundItems" element={ <FoundItems/>}></Route>
        <Route path="/LostItems" element={ <LostItems/>}></Route>
                <Route path="/loginPage" element={ <LoginPage/>}></Route>
                <Route path="/userdashBoard" element={ <UserDashBoard state={state} loading={loading} AllItems={AllItems} AllFoundItems={AllFoundItems} setNamevalue={setNamevalue}/>}>
                </Route>
                <Route path='/DisplayData' element={<DisplayData loading={loading} AllItems={AllItems} AllFoundItems={AllFoundItems} setNamevalue={setNamevalue} />}></Route>
